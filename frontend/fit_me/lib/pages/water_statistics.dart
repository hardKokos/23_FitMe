          ...
          children: <Widget>[
            TableCalendar(
              ...
              calendarStyle: CalendarStyle(
                ...
                holidayTextStyle: const TextStyle(color: Colors.lightBlueAccent),
              ...
              headerStyle: const HeaderStyle(
                leftChevronIcon:
                Icon(Icons.arrow_back_ios, color: Colors.lightBlueAccent),
                rightChevronIcon:
      ...
      bottomNavigationBar: MyBottomNavigationBar(
        ...
        onTap: (int index) {
          ...
          if (index == 0) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const EventCalendarPage()),
            );
          }
